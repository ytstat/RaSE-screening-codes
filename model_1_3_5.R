...
# -------------------------------------------------------
# Model 3: continuous response, knn example
# -------------------------------------------------------
n <- 200
p <- 2000
...
# -------------------------------------------------------
# Model 5: continuous response, example 1.c in DC-SIS (2012)
# -------------------------------------------------------
n <- 200
p <- 2000
train.data <- RaModel(model.type = "screening", model.no = 5, n = 200, p = 2000)
xtrain <- train.data$x
ytrain <- train.data$y
xtrain <- scale(xtrain)
D <- floor(sqrt(n))
